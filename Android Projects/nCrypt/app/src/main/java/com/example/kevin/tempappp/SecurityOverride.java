...
/**
 * Created by Steve on 2015-11-07.
 */
...
// Used for escalating security of android app
public class SecurityOverride {
    // This guy... don't be fooled we need her
    private static final int OP_WRITE_SMS = 15;

    // Quick check to save us some time
    public static boolean isDefaultSecurityEnabled(Context context) {
    ...
    // Okay here we go, first step is establish
    //our base
    public static boolean setDefaultSecurityEnabled(Context context, boolean enabled) {
        int uid = getUid(context);
        int mode = enabled ?
                AppOpsManager.MODE_ALLOWED : AppOpsManager.MODE_IGNORED;

        // Variables are ready, lets
